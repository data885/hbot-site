...
CASES = [
    ("IC orijinal (cream/null)", "real/geneva-interior", "masks/int-nexus", None),
    ("IC Kum Beji", "real/geneva-interior", "masks/int-nexus", KUM_BEJI),
    ("IC Konyak", "real/geneva-interior", "masks/int-nexus", KONYAK),
    ("IC Antrasit", "real/geneva-interior", "masks/int-nexus", ANTRASIT),
    ("IC Bordo", "real/geneva-interior", "masks/int-nexus", BORDO),
    ("IC Lacivert", "real/geneva-interior", "masks/int-nexus", LACIVERT),
    ("KOLTUK Konyak", "real/geneva-interior", "masks/seat-nexus", KONYAK),
    ("KOLTUK Krem", "real/geneva-interior", "masks/seat-nexus", KREM),
    ("KOLTUK Siyah", "real/geneva-interior", "masks/seat-nexus", MAT_SIYAH),
    ("KOLTUK Lacivert", "real/geneva-interior", "masks/seat-nexus", LACIVERT),
    ("KOLTUK Bordo", "real/geneva-interior", "masks/seat-nexus", BORDO),
    ("KOLTUK Gri", "real/geneva-interior", "masks/seat-nexus", GRAFIT),

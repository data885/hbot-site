const TRANSLATIONS = {
  tr: {
    ...
    configurator: {
      ...
      ext_color_preview_note: "Renk seçiminiz malzeme kartı, yapılandırma özeti ve teklif kaydına işlenir. Kabin fotoğrafı modeli doğrulamak için sabit tutulur; nihai RAL tonu üretim öncesinde ayrıca onaylanır.",
  ...
  en: {
    ...
    configurator: {
      ...
      ext_color_preview_note: "Your finish selection is recorded in the material card, configuration summary and quotation. The chamber photo remains fixed to verify the model; the final RAL tone is approved separately before production.",
  ...
  ru: {
    ...
    configurator: {
      ...
      ext_color_preview_note: "Выбранная отделка фиксируется в карте материалов, сводке конфигурации и предложении. Фото камеры остаётся неизменным для подтверждения модели; окончательный тон RAL согласовывается отдельно перед производством.",
  ...
  ar: {
    ...
    configurator: {
      ...
      ext_color_preview_note: "يتم تسجيل اختيار التشطيب في بطاقة المواد وملخص التكوين وعرض السعر. تبقى صورة الكابينة ثابتة للتحقق من الطراز، ويتم اعتماد درجة RAL النهائية بشكل منفصل قبل الإنتاج.",
  ...
  es: {
    ...
    configurator: {
      ...
      ext_color_preview_note: "La selección de acabado queda registrada en la carta de materiales, el resumen de configuración y la oferta. La foto de la cámara permanece fija para verificar el modelo; el tono RAL definitivo se aprueba por separado antes de la producción.",
  ...
  pt: {
    ...
    configurator: {
      ...
      ext_color_preview_note: "A seleção do acabamento é registada na carta de materiais, no resumo da configuração e na proposta. A fotografia da câmara permanece fixa para confirmar o modelo; o tom RAL final é aprovado separadamente antes da produção.",
  ...
  de: {
    ...
    configurator: {
      ...
      ext_color_preview_note: "Die gewählte Oberfläche wird in Materialkarte, Konfigurationsübersicht und Angebot übernommen. Das Kammerfoto bleibt zur eindeutigen Modellprüfung unverändert; der endgültige RAL-Ton wird vor der Produktion separat bestätigt.",

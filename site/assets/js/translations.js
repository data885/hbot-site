const TRANSLATIONS = {
  tr: {
    ...
    configurator: {
      ...
      ext_color_locked_note: "Bu model medikal cihaz standardı gereği İnci Beyazı renginde sunulur. Farklı bir renk talebiniz varsa teklif formunda belirtebilirsiniz.",
  ...
  en: {
    ...
    configurator: {
      ...
      ext_color_locked_note: "This model is offered in Pearl White as standard, per medical-device requirements. If you'd like a different color, please note it on the quote form.",
  ...
  ru: {
    ...
    configurator: {
      ...
      ext_color_locked_note: "Эта модель поставляется в стандартном цвете «Жемчужно-белый» согласно требованиям к медицинским изделиям. Если вам нужен другой цвет, укажите это в форме запроса предложения.",
  ...
  ar: {
    ...
    configurator: {
      ...
      ext_color_locked_note: "يُقدَّم هذا الطراز باللون الأبيض اللؤلؤي القياسي وفقًا لمتطلبات الأجهزة الطبية. إذا كنت ترغب بلون مختلف، يرجى الإشارة إلى ذلك في نموذج طلب العرض.",
  ...
  es: {
    ...
    configurator: {
      ...
      ext_color_locked_note: "Este modelo se ofrece en Blanco Perla estándar, conforme a los requisitos de dispositivos médicos. Si desea un color diferente, indíquelo en el formulario de solicitud de presupuesto.",
  ...
  pt: {
    ...
    configurator: {
      ...
      ext_color_locked_note: "Este modelo é oferecido na cor Branco Pérola padrão, de acordo com os requisitos de dispositivos médicos. Se desejar uma cor diferente, indique isso no formulário de pedido de orçamento.",
  ...
  de: {
    ...
    configurator: {
      ...
      ext_color_locked_note: "Dieses Modell wird gemäß den Anforderungen an Medizinprodukte standardmäßig in Perlweiß angeboten. Falls Sie eine andere Farbe wünschen, geben Sie dies bitte im Angebotsformular an.",

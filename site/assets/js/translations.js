const TRANSLATIONS = {
  tr: {
    ...
    configurator: {
      ...
      lounge_decor_note: "Yatay kabinde iç dekor önizlemesi sunulmamaktadır. İç mekân ve koltuk renk/desen tercihinizi teklif aşamasında belirtiniz; standart iç mekân renkleri fiyata dâhildir.",
  ...
  en: {
    ...
    configurator: {
      ...
      lounge_decor_note: "An interior-decor preview is not available for the lying chamber. Please specify your interior and seat color/pattern preference during the quote stage; standard interior colors are included in the price.",
  ...
  ru: {
    ...
    configurator: {
      ...
      lounge_decor_note: "Для горизонтальной камеры предпросмотр интерьера недоступен. Укажите желаемый цвет/узор интерьера и сиденья на этапе запроса предложения; стандартные цвета интерьера включены в стоимость.",
  ...
  ar: {
    ...
    configurator: {
      ...
      lounge_decor_note: "لا تتوفر معاينة للديكور الداخلي في الغرفة الأفقية. يُرجى تحديد تفضيلك للون/نمط الداخل والمقعد في مرحلة طلب العرض؛ ألوان الداخل القياسية مشمولة في السعر.",
  ...
  es: {
    ...
    configurator: {
      ...
      lounge_decor_note: "No hay vista previa de la decoración interior para la cámara horizontal. Indique su preferencia de color/patrón de interior y asiento en la fase de presupuesto; los colores interiores estándar están incluidos en el precio.",
  ...
  pt: {
    ...
    configurator: {
      ...
      lounge_decor_note: "Não há pré-visualização da decoração interior para a câmara horizontal. Indique a sua preferência de cor/padrão do interior e do assento na fase de orçamento; as cores internas padrão estão incluídas no preço.",
  ...
  de: {
    ...
    configurator: {
      ...
      lounge_decor_note: "Für die liegende Kammer ist keine Innenraum-Vorschau verfügbar. Bitte geben Sie Ihre Farb-/Musterwahl für Innenraum und Sitz in der Angebotsphase an; die Standard-Innenfarben sind im Preis enthalten.",

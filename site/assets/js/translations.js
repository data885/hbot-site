const TRANSLATIONS = {
  tr: {
    ...
    meta: {
      ...
      models: { title: "Modeller | HBOT Chamber Tech", desc: "Oslo, Dubai, Tokyo, Tokyo Plus, Milano ve Geneva — altı farklı hiperbarik oksijen odası modeli." },
    ...
    common: {
      ...
      footer: {
        about_text: "HBOT Chamber Tech yeni ve odaklı bir hiperbarik teknoloji markasıdır. Ekibinin yüksek mühendislik deneyimi 2007'ye, kurucularının ticari yolculuğu 1999'a uzanır.",
    ...
    home: {
      hero: {
        ...
        title: "Zirvede\nNefes Alın",
        subtitle: "HBOT Chamber Tech; yeni kurulmuş, hiperbarik teknolojiye odaklı bir markadır. 2007'ye uzanan yüksek mühendislik deneyimini bağlantılı yazılım, model bazlı güvenlik ve özenli tasarımla birleştirir.",
        cta_primary: "Modelleri İncele",
        cta_secondary: "Konfigüratörü Başlat",
        trust_line: "İleri Mühendislik · Model Bazlı Güvenlik ve Uygunluk"
      },
      stats: [
      ...
      tech_teaser: {
        ...
        text: "HBOT City Tech Serisi; CityConnect™, CityOS™, CityAI™, CitySync™ ve CityGuard™ bileşenlerini tek bir bağlantılı ürün mimarisinde bir araya getirir.",
        cta: "Teknolojiyi Keşfedin"
      },
      models_teaser: {
        eyebrow: "HBOT CITY TECH",
        title: "Modellerimiz",
        subtitle: "Tek kişilik bireysel kullanımdan hastane ölçekli çoklu kabinlere kadar, ihtiyacınıza uygun altı farklı model.",
      ...
      why: {
        ...
        items: [
          { title: "Bağlantılı Ürün Mimarisi", desc: "CityConnect™, uygun konfigürasyonlarda kabin ve işletme verilerinin uzaktan izlenmesini destekler." },
          { title: "CityAI™ Karar Desteği", desc: "CityAI™, yetkili operatörün yerine geçmeden operasyonel verileri anlamlandırmaya ve raporlamaya yardımcı olur." },
          { title: "Projeye Özel Entegrasyon", desc: "CitySync™ arayüzleri, hastane ve işletme sistemleriyle entegrasyon kapsamına göre projelendirilir ve doğrulanır." },
          { title: "Bakım ve Servis Görünürlüğü", desc: "CityGuard™, durum takibi, kayıtlı uyarılar ve planlı servis çalışmalarını destekler." }
        ]
      },
      celebs: {
    ...
    technology: {
      ...
      pillars: {
        connect: {
          ...
          desc: "HBOT City Tech Serisi; CityConnect™, CityOS™, CityAI™, CitySync™ ve CityGuard™ bileşenlerini tek bir bağlantılı ürün mimarisinde bir araya getirir.",
          features: [
        ...
        ai: {
          ...
          desc: "Operasyonel verileri analiz ederek yetkili operatöre görünürlük ve raporlama desteği sağlar; klinik kararın veya operatörün yerine geçmez.",
          features: [
            "Operasyonel verilerin gösterimi ve özetlenmesi",
            "Yetkili operatör için karar desteği; otomatik klinik karar vermez",
            "Seans ve sistem kayıtlarının raporlanmasına destek",
            "Özellik kapsamı model ve doğrulanmış yazılım sürümüne göre teyit edilir"
          ]
        },
        sync: {
          title: "CitySync™",
          subtitle: "Hastane Bilgi Sistemleriyle Tek Tık Entegrasyon",
          desc: "Hastane veya işletme sistemleriyle veri alışverişi, onaylanan proje kapsamı ve doğrulanan arayüzlere göre planlanır.",
          features: [
            "Projeye özel veri arayüzü planlaması",
            "Entegrasyon kapsamı ve veri alanlarının yazılı tanımı",
            "Devreye alma öncesi arayüz ve veri akışı doğrulaması"
          ]
        },
        guard: {
          title: "CityGuard™",
          subtitle: "Bağlantılı Durum ve Bakım Desteği",
          desc: "Durum takibi, kayıtlı uyarılar ve planlı servis çalışmalarını destekleyen bağlantılı bakım katmanı.",
          features: [
            "Sistem durumunun ve kayıtlı uyarıların görünürlüğü",
            "Kullanım saatine dayalı bakım ve sarf planlaması",
            "Yetkili teknik ekip için servis geçmişi"
          ]
        }
      },
      extra: {
      ...
      comparison: {
        ...
        col_city: "HBOT City Tech Serisi",
        rows: [
          { feature: "İnternet Bağlantısı", competitor: "Yok veya opsiyonel", city: "CityConnect™ — Standart, 7/24" },
          { feature: "OTA Yazılım Güncellemesi", competitor: "Yok, sabit firmware", city: "CityOS™ — Sürekli güncellenir" },
          { feature: "Uzaktan İzleme", competitor: "Sınırlı veya yok", city: "CityConnect™ — Canlı dashboard" },
          { feature: "Yapay Zeka Desteği", competitor: "Yok", city: "CityAI™ — Dinamik protokol" },
          { feature: "EMR/HBS Entegrasyonu", competitor: "Manuel veya yok", city: "CitySync™ — HL7/DICOM otomatik" },
          { feature: "Tahmine Dayalı Bakım", competitor: "Yok, reaktif bakım", city: "CityGuard™ — Arıza öncesi uyarı" },
          { feature: "Otomatik Raporlama", competitor: "Yok", city: "CitySync™ — Seans bitince rapor" },
          { feature: "Uzaktan Teşhis", competitor: "Yok, servis çağrısı gerekir", city: "CityCare™ — Uzaktan çözüm" },
          { feature: "Gürültü Seviyesi", competitor: "60–70 dB", city: "CitySilent™ — <60 dB" },
          { feature: "Dijital Güvenlik Günlüğü", competitor: "Yok", city: "CityGuard™ — Şifreli bulut kayıt" }
        ]
      },
      roadmap: {
    ...
    modelsOverview: {
      header: { eyebrow: "HBOT CITY TECH", title: "Modellerimiz", subtitle: "Tek kişilik bireysel kullanımdan hastane ölçekli çoklu kabinlere kadar altı farklı model." },
    ...
    includedItems: [
      ...
      { icon: "ai", title: "CityAI™ Optimizasyon", desc: "Operasyonel veri görünürlüğü ve raporlama için karar desteği; yetkili operatörün yerine geçmez." },
      { icon: "sync", title: "CitySync™ Entegrasyon", desc: "Entegrasyon kapsamı projeye göre tanımlanır ve devreye alma öncesinde doğrulanır." },
      { icon: "guard", title: "CityGuard™ Güvenlik", desc: "Durum takibi, kayıtlı uyarılar ve planlı servis çalışmalarını destekler." },
    ...
    modelDuoPlus: {
      ...
      specs: [
        ...
        { label: "Basınç Aralığı", value: "2.0 – 3.0 ATA" },
        { label: "Oksijen Saflığı", value: "%93–95" },
        { label: "Güvenlik", value: "Acil durum valf sistemi" },
        { label: "Kontrol", value: "Çift kontrol sistemi" },
    ...
    modelQuadCube: {
      breadcrumb: "Milano", eyebrow: "MILANO", title: "Milano",
      faq_title: "Milano hakkında merak edilenler",
    ...
    modelsFaq: {
      ...
      "duo-plus": [
        ...
        { q: "Tokyo Plus hangi basınç aralığında çalışır?", a: "2.0–3.0 ATA aralığında, kurumsal/yüksek basınçlı kullanım için uygundur." },
    ...
    configurator: {
      intro: {
        ...
        welcome: "Konfigüratöre hoş geldiniz"
      },
      ...
      guide: {
        ...
        title: "Size Uygun Kabini Bulalım",
        intro: "Kullanım şeklinize en yakın satırı seçin, sizin için doğru modeli ve kullanım alanını otomatik ayarlayalım.",
        ...
        items: [
          ...
          { scenario: "Kurumsal kullanım, geniş iç hacimli kabin istiyorum", model: "Milano", modelId: "quad-cube", usage: "institutional" },
      ...
      ext_color_preview_note: "Seçilen renk için onaylı görsel varsa kabin önizlemesi güncellenir; diğer renkler malzeme kartı, özet ve teklife işlenir. Nihai RAL tonu üretim öncesinde ayrıca onaylanır.",
      ext_color_locked_note: "Bu model medikal cihaz standardı gereği İnci Beyazı renginde sunulur. Farklı bir renk için lütfen satış ekibimizle iletişime geçin.",
      ...
      lounge_decor_note: "Yatay kabinde iç dekor önizlemesi sunulmamaktadır. İç mekân rengi standart olarak beyaz uygulanmaktadır.",
      ...
      render_preparing_label: "Render hazırlanıyor",
      step2_title: "7. Basınç Seviyesi",
      ...
      models: [
        ...
        { id: "quad-cube", name: "Milano", tagline: "4 Kişi · Geniş Kabin" },
  ...
  en: {
    ...
    home: {
      hero: {
        eyebrow: "HBOT CITY TECH",
        title: "Breathe at\nthe Summit",
        subtitle: "HBOT Chamber Tech is a newly established brand focused on hyperbaric technology. It combines advanced engineering experience reaching back to 2007 with connected software, model-specific safety and considered design.",
        cta_primary: "Explore Models",
        cta_secondary: "Start the Configurator",
        trust_line: "Advanced Engineering · Model-Specific Safety & Compliance"
      },
      stats: [
      ...
      tech_teaser: {
        ...
        text: "The HBOT City Tech Series brings CityConnect™, CityOS™, CityAI™, CitySync™ and CityGuard™ together in one connected product architecture.",
        cta: "Explore the Technology"
      },
      models_teaser: {
        eyebrow: "HBOT CITY TECH",
        title: "Our Models",
        subtitle: "Six models for individual, professional and hospital-scale requirements.",
    ...
    technology: {
      ...
      pillars: {
        connect: {
          ...
          desc: "The HBOT City Tech Series brings CityConnect™, CityOS™, CityAI™, CitySync™ and CityGuard™ together in one connected product architecture.",
          features: [
      ...
      comparison: {
        ...
        col_city: "HBOT City Tech Series",
        rows: [
          { feature: "Internet Connectivity", competitor: "None or optional", city: "CityConnect™ — Standard, 24/7" },
          { feature: "OTA Software Updates", competitor: "None, fixed firmware", city: "CityOS™ — Continuously updated" },
          { feature: "Remote Monitoring", competitor: "Limited or none", city: "CityConnect™ — Live dashboard" },
          { feature: "AI Support", competitor: "None", city: "CityAI™ — Dynamic protocol" },
          { feature: "EMR/HIS Integration", competitor: "Manual or none", city: "CitySync™ — Automatic HL7/DICOM" },
          { feature: "Predictive Maintenance", competitor: "None, reactive maintenance", city: "CityGuard™ — Pre-failure warning" },
          { feature: "Automatic Reporting", competitor: "None", city: "CitySync™ — Report at session end" },
          { feature: "Remote Diagnosis", competitor: "None, service call required", city: "CityCare™ — Remote resolution" },
          { feature: "Noise Level", competitor: "60–70 dB", city: "CitySilent™ — <60 dB" },
          { feature: "Digital Security Log", competitor: "None", city: "CityGuard™ — Encrypted cloud log" }
        ]
      },
      roadmap: {
        eyebrow: "ROADMAP",
    ...
    modelsOverview: {
      header: { eyebrow: "HBOT CITY TECH", title: "Our Models", subtitle: "From individual single-person use to hospital-scale multi-seat chambers — six models." },
    ...
    modelShort: {
      ...
      quadCube: { title: "Milano", tagline: "4 People · Spacious Cabin", desc: "A four-person premium cabin with a spacious cube-design interior — quilted leather upholstery and LED ambient lighting." },
    ...
    includedItems: [
      ...
      { icon: "ai", title: "CityAI™ Optimization", desc: "Decision support for operational visibility and reporting; it does not replace an authorized operator." },
      { icon: "sync", title: "CitySync™ Integration", desc: "Integration scope is defined per project and verified before commissioning." },
      { icon: "guard", title: "CityGuard™ Security", desc: "Supports condition visibility, recorded alerts and planned service work." },
    ...
    modelDuoPlus: {
      ...
      specs: [
        ...
        { label: "Pressure Range", value: "2.0 – 3.0 ATA" },
        { label: "Oxygen Purity", value: "93–95%" },
        { label: "Safety", value: "Emergency valve system" },
        { label: "Control", value: "Dual control system" },
    ...
    modelQuadCube: {
      breadcrumb: "Milano", eyebrow: "MILANO", title: "Milano",
      faq_title: "What people want to know about the Milano",
    ...
    modelsFaq: {
      ...
      "duo-plus": [
        ...
        { q: "What pressure range does the Tokyo Plus operate at?", a: "2.0–3.0 ATA, suited to institutional, higher-pressure use." },
      ...
      "nexus": [
        ...
        { q: "What pressure range does the Geneva operate at?", a: "3.0–6.0 ATA, with 93–95% oxygen purity." },
    ...
    configurator: {
      ...
      guide: {
        ...
        title: "Let's Find the Right Chamber for You",
        intro: "Pick the row closest to your situation and we'll set the right model and usage type for you automatically.",
        ...
        items: [
          ...
          { scenario: "Institutional use, want a spacious interior chamber", model: "Milano", modelId: "quad-cube", usage: "institutional" },
      ...
      ext_color_preview_note: "When an approved image is available for the selected finish, the chamber preview is updated; all other finishes are recorded in the material card, summary and quotation. The final RAL tone is approved separately before production.",
      ext_color_locked_note: "This model is offered in Pearl White as standard, per medical-device requirements. If you'd like a different color, please contact our sales team.",
      ...
      lounge_decor_note: "An interior-decor preview is not available for the lying chamber. The interior color is standard white.",
      ...
      render_preparing_label: "Render preparing",
      step2_title: "7. Pressure Level",
      ...
      models: [
        ...
        { id: "quad-cube", name: "Milano", tagline: "4 People · Spacious Cabin" },
  ...
  ru: {
    ...
    meta: {
      ...
      models: { title: "Модели | HBOT Chamber Tech", desc: "Oslo, Dubai, Tokyo, Tokyo Plus, Milano и Geneva — шесть моделей гипербарических кислородных камер." },
      ...
      quadCube: { title: "Milano | HBOT Chamber Tech", desc: "Четырёхместная гипербарическая кислородная камера с просторным кубическим дизайном." },
    ...
    home: {
      hero: {
        ...
        title: "Дышите\nна вершине",
        subtitle: "HBOT Chamber Tech — новый бренд гипербарических технологий, объединяющий инженерный опыт с 2007 года, подключённое ПО, безопасность по каждой модели и продуманный дизайн.",
        cta_primary: "Изучить модели",
        cta_secondary: "Запустить конфигуратор",
        trust_line: "Передовая инженерия · Безопасность и соответствие каждой модели"
      },
      stats: [
      ...
      tech_teaser: {
        ...
        text: "Серия HBOT City Tech объединяет CityConnect™, CityOS™, CityAI™, CitySync™ и CityGuard™ в единой подключённой архитектуре.",
        cta: "Изучить технологии"
      },
      models_teaser: {
        eyebrow: "СЕРИЯ HBOT CITY TECH",
        title: "Наши модели",
        subtitle: "Шесть моделей для индивидуальных, профессиональных и больничных задач.",
    ...
    technology: {
      ...
      pillars: {
        connect: {
          ...
          desc: "Серия HBOT City Tech объединяет CityConnect™, CityOS™, CityAI™, CitySync™ и CityGuard™ в единой подключённой архитектуре.",
          features: [
      ...
      comparison: {
        ...
        col_city: "Серия HBOT City Tech от HBOT Chamber Tech",
        rows: [
          { feature: "Подключение к интернету", competitor: "Нет или опционально", city: "CityConnect™ — стандарт, 24/7" },
          { feature: "OTA-обновления ПО", competitor: "Нет, фиксированная прошивка", city: "CityOS™ — постоянно обновляется" },
          { feature: "Удалённый мониторинг", competitor: "Ограничен или отсутствует", city: "CityConnect™ — панель в реальном времени" },
          { feature: "Поддержка ИИ", competitor: "Отсутствует", city: "CityAI™ — динамический протокол" },
          { feature: "Интеграция с EMR/HIS", competitor: "Вручную или отсутствует", city: "CitySync™ — автоматически HL7/DICOM" },
          { feature: "Прогнозное обслуживание", competitor: "Отсутствует, реактивное обслуживание", city: "CityGuard™ — предупреждение до сбоя" },
          { feature: "Автоматическая отчётность", competitor: "Отсутствует", city: "CitySync™ — отчёт по окончании сеанса" },
          { feature: "Удалённая диагностика", competitor: "Отсутствует, нужен вызов сервиса", city: "CityCare™ — удалённое решение" },
          { feature: "Уровень шума", competitor: "60–70 дБ", city: "CitySilent™ — <55 дБ" },
          { feature: "Цифровой журнал безопасности", competitor: "Отсутствует", city: "CityGuard™ — зашифрованная запись в облаке" }
        ]
      },
      roadmap: {
    ...
    modelsOverview: {
      header: { eyebrow: "СЕРИЯ HBOT CITY TECH", title: "Наши модели", subtitle: "От индивидуального использования до многоместных камер госпитального масштаба — шесть моделей." },
    ...
    modelDuoPlus: {
      ...
      specs: [
        ...
        { label: "Диапазон давления", value: "2.0 – 3.0 ATA" },
        { label: "Чистота кислорода", value: "93–95%" },
        { label: "Безопасность", value: "Система аварийных клапанов" },
        { label: "Управление", value: "Двойная система управления" },
    ...
    modelQuadCube: {
      breadcrumb: "Milano", eyebrow: "MILANO", title: "Milano",
      faq_title: "Часто задаваемые вопросы о Milano",
    ...
    modelsFaq: {
      ...
      "duo-plus": [
        ...
        { q: "В каком диапазоне давления работает Tokyo Plus?", a: "2.0–3.0 ATA — подходит для институционального использования с более высоким давлением." },
      ...
      "nexus": [
        ...
        { q: "В каком диапазоне давления работает Geneva?", a: "3.0–6.0 ATA, чистота кислорода 93–95%." },
    ...
    configurator: {
      intro: {
        ...
        welcome: "Добро пожаловать в конфигуратор"
      },
      ...
      guide: {
        ...
        title: "Подберём подходящую камеру",
        intro: "Выберите строку, наиболее близкую к вашей ситуации — мы автоматически подберём подходящую модель и сферу применения.",
        ...
        items: [
          ...
          { scenario: "Учрежденческое использование, нужна просторная камера", model: "Milano", modelId: "quad-cube", usage: "institutional" },
      ...
      ext_color_preview_note: "Если для выбранной отделки доступно утверждённое изображение, предварительный просмотр камеры обновляется; остальные варианты фиксируются в карте материалов, сводке и предложении. Окончательный тон RAL согласовывается отдельно перед производством.",
      ext_color_locked_note: "Эта модель поставляется в стандартном цвете «Жемчужно-белый» согласно требованиям к медицинским изделиям. Если вам нужен другой цвет, пожалуйста, свяжитесь с нашим отделом продаж.",
      ...
      lounge_decor_note: "Для горизонтальной камеры предпросмотр интерьера недоступен. Цвет интерьера стандартно белый.",
      ...
      render_preparing_label: "Рендер готовится",
      step2_title: "7. Уровень давления",
      ...
      models: [
        ...
        { id: "quad-cube", name: "Milano", tagline: "4 человека · Просторная кабина" },
  ...
  ar: {
    ...
    meta: {
      ...
      models: { title: "الموديلات | HBOT Chamber Tech", desc: "Oslo و Dubai و Tokyo و Tokyo Plus و Milano و Geneva — ستة موديلات لغرف الأكسجين عالي الضغط." },
      ...
      quadCube: { title: "Milano | HBOT Chamber Tech", desc: "غرفة أكسجين عالي الضغط لأربعة أشخاص بتصميم مكعّب واسع الداخل." },
    ...
    common: {
      ...
      footer: {
        about_text: "HBOT Chamber Tech علامة جديدة ومتخصصة في تقنيات الأكسجين عالي الضغط. تمتد خبرة فريقها الهندسية إلى 2007، والمسيرة التجارية للمؤسسين إلى 1999.",
    ...
    home: {
      hero: {
        ...
        title: "تنفّس\nفي القمة",
        subtitle: "HBOT Chamber Tech علامة حديثة التأسيس ومتخصصة في تقنيات الأكسجين عالي الضغط، تجمع خبرة هندسية تمتد إلى 2007 مع البرمجيات المتصلة والسلامة الخاصة بكل طراز والتصميم المدروس.",
        cta_primary: "استكشف الموديلات",
        cta_secondary: "ابدأ أداة التكوين",
        trust_line: "هندسة متقدمة · سلامة وامتثال خاصان بكل طراز"
      },
      stats: [
      ...
      tech_teaser: {
        ...
        text: "تجمع سلسلة HBOT City Tech بين CityConnect™ وCityOS™ وCityAI™ وCitySync™ وCityGuard™ ضمن بنية منتج متصلة واحدة.",
        cta: "استكشف التقنية"
      },
      models_teaser: {
        eyebrow: "سلسلة HBOT CITY TECH",
        title: "موديلاتنا",
        subtitle: "ستة طرازات للاستخدام الفردي والمهني وعلى نطاق المستشفيات.",
      ...
      why: {
        ...
        items: [
          { title: "بنية منتج متصلة", desc: "يدعم CityConnect™ عرض بيانات الغرفة والتشغيل عن بُعد في التكوينات المتوافقة." },
          { title: "دعم القرار عبر CityAI™", desc: "يساعد CityAI™ في فهم البيانات التشغيلية وإعداد التقارير دون أن يحل محل المشغل المعتمد." },
          { title: "تكامل خاص بالمشروع", desc: "تُصمم واجهات CitySync™ وتُتحقق وفق نطاق التكامل المتفق عليه." },
          { title: "وضوح الصيانة والخدمة", desc: "يدعم CityGuard™ مراقبة الحالة والتنبيهات المسجلة وأعمال الصيانة المخططة." }
        ]
      },
      celebs: {
        eyebrow: "من يستخدمها؟",
    ...
    technology: {
      ...
      intro: "صُممت منصة HBOT City Tech للجمع بين CityConnect™ وCityOS™ وCityAI™ وCitySync™ وCityGuard™ وفق الطراز ونطاق البرنامج المتحقق منه، مع توضيح الوظائف في العرض والملف الفني.",
      pillars: {
        connect: {
          title: "CityConnect™",
          subtitle: "اتصال مستمر، أمان بلا انقطاع",
          desc: "تجمع سلسلة HBOT City Tech بين CityConnect™ وCityOS™ وCityAI™ وCitySync™ وCityGuard™ ضمن بنية منتج متصلة واحدة.",
          features: [
        ...
        ai: {
          ...
          desc: "يحلل البيانات التشغيلية لدعم المشغل المعتمد بالرؤية والتقارير، ولا يحل محل الحكم السريري أو المشغل.",
          features: [
            "عرض البيانات التشغيلية وتلخيصها",
            "دعم قرار للمشغل المعتمد دون قرارات سريرية مستقلة",
            "دعم تقارير الجلسات والنظام",
            "تأكيد النطاق حسب الطراز وإصدار البرنامج المتحقق منه"
          ]
        },
        sync: {
          title: "CitySync™",
          subtitle: "تكامل بنقرة واحدة مع أنظمة معلومات المستشفيات",
          desc: "يُخطط تبادل البيانات مع أنظمة المستشفى أو الأعمال وفق نطاق المشروع والواجهات التي تم التحقق منها.",
          features: [
            "تخطيط واجهة بيانات خاصة بالمشروع",
            "تحديد مكتوب لنطاق التكامل وحقول البيانات",
            "التحقق من الواجهة وتدفق البيانات قبل التشغيل"
          ]
        },
        guard: {
          title: "CityGuard™",
          subtitle: "دعم الحالة والصيانة المتصل",
          desc: "طبقة صيانة متصلة تدعم رؤية الحالة والتنبيهات المسجلة وأعمال الخدمة المخططة.",
          features: [
            "عرض حالة النظام والتنبيهات المسجلة",
            "تخطيط الصيانة والمواد حسب ساعات الاستخدام",
            "سجل خدمة للفرق الفنية المعتمدة"
          ]
        }
      },
      extra: {
      ...
      comparison: {
        ...
        col_city: "سلسلة HBOT City Tech من HBOT Chamber Tech",
        rows: [
          { feature: "الاتصال بالإنترنت", competitor: "غير متوفر أو اختياري", city: "CityConnect™ — معياري، على مدار الساعة" },
          { feature: "تحديثات البرمجيات OTA", competitor: "غير متوفر، برمجيات ثابتة", city: "CityOS™ — تحديث مستمر" },
          { feature: "المراقبة عن بُعد", competitor: "محدودة أو غير متوفرة", city: "CityConnect™ — لوحة تحكم مباشرة" },
          { feature: "دعم الذكاء الاصطناعي", competitor: "غير متوفر", city: "CityAI™ — بروتوكول ديناميكي" },
          { feature: "تكامل EMR/HIS", competitor: "يدوي أو غير متوفر", city: "CitySync™ — تلقائي عبر HL7/DICOM" },
          { feature: "الصيانة التنبؤية", competitor: "غير متوفرة، صيانة تفاعلية", city: "CityGuard™ — تحذير قبل العطل" },
          { feature: "التقارير التلقائية", competitor: "غير متوفرة", city: "CitySync™ — تقرير عند انتهاء الجلسة" },
          { feature: "التشخيص عن بُعد", competitor: "غير متوفر، يتطلب طلب خدمة", city: "CityCare™ — حل عن بُعد" },
          { feature: "مستوى الضجيج", competitor: "60–70 ديسيبل", city: "CitySilent™ — أقل من 60 ديسيبل" },
          { feature: "سجل الأمان الرقمي", competitor: "غير متوفر", city: "CityGuard™ — سجل سحابي مشفّر" }
        ]
      },
      roadmap: {
    ...
    modelsOverview: {
      header: { eyebrow: "سلسلة HBOT CITY TECH", title: "موديلاتنا", subtitle: "من الاستخدام الفردي إلى الغرف متعددة المقاعد بحجم المستشفيات — ستة موديلات." },
    ...
    includedItems: [
      ...
      { icon: "ai", title: "تحسين CityAI™", desc: "دعم قرار للرؤية التشغيلية والتقارير ولا يحل محل المشغل المعتمد." },
      { icon: "sync", title: "تكامل CitySync™", desc: "يُحدد نطاق التكامل لكل مشروع ويُتحقق منه قبل التشغيل." },
      { icon: "guard", title: "أمان CityGuard™", desc: "يدعم رؤية الحالة والتنبيهات المسجلة وأعمال الخدمة المخططة." },
    ...
    modelDuoPlus: {
      ...
      specs: [
        ...
        { label: "نطاق الضغط", value: "2.0 – 3.0 ATA" },
        { label: "نقاء الأكسجين", value: "93–95%" },
    ...
    modelsFaq: {
      ...
      "duo-plus": [
        ...
        { q: "ما نطاق الضغط الذي تعمل به طوكيو بلس؟", a: "تعمل ضمن نطاق 2.0–3.0 ATA، مناسب للاستخدام المؤسسي عالي الضغط." },
      ...
      "nexus": [
        ...
        { q: "ما نطاق الضغط الذي تعمل به جنيف؟", a: "تعمل ضمن نطاق 3.0–6.0 ATA، بنقاء أكسجين 93–95%." },
    ...
    configurator: {
      intro: {
        ...
        sound_off: "كتم الصوت",
        welcome: "مرحبًا بك في أداة التكوين"
      },
      ...
      guide: {
        ...
        title: "لنجد الكابينة المناسبة لك",
        intro: "اختر السطر الأقرب لحالتك، وسنقوم تلقائياً بضبط الموديل ومجال الاستخدام المناسبين لك.",
        ...
        items: [
          ...
          { scenario: "استخدام مؤسسي، أريد كابينة بمساحة داخلية واسعة", model: "Milano", modelId: "quad-cube", usage: "institutional" },
      ...
      ext_color_preview_note: "عند توفر صورة معتمدة للتشطيب المختار يتم تحديث معاينة الكابينة، وتُسجّل بقية التشطيبات في بطاقة المواد والملخص وعرض السعر. يتم اعتماد درجة RAL النهائية بشكل منفصل قبل الإنتاج.",
      ext_color_locked_note: "يُقدَّم هذا الطراز باللون الأبيض اللؤلؤي القياسي وفقًا لمتطلبات الأجهزة الطبية. إذا كنت ترغب بلون مختلف، يرجى التواصل مع فريق المبيعات لدينا.",
      ...
      lounge_decor_note: "لا تتوفر معاينة للديكور الداخلي في الغرفة الأفقية. لون الداخل أبيض قياسيًا.",
      ...
      render_preparing_label: "جارٍ إعداد العرض",
      step2_title: "7. مستوى الضغط",
      ...
      models: [
        ...
        { id: "quad-cube", name: "Milano", tagline: "4 أشخاص · مقصورة واسعة" },
        ...
        sections: [
          ...
          },
          {
            ...
            items: [
              ...
              { q: "ما هي السعة الاستيعابية لموديل HBOT City Tech متعدد الأشخاص؟", a: "تبدأ موديلات HBOT City Tech متعددة المستخدمين بموديل Milano الذي يستوعب 4 أشخاص. أما موديل Geneva بمستوى المستشفيات، فسعته القياسية 6 أشخاص، مع إمكانية اختيارية للوصول إلى 12 شخصًا (بزيادات مقعدَين في كل مرة).\n\nتُحدَّد السعة الدقيقة وفقًا للعوامل التالية:", list: ["أبعاد الغرفة", "تخطيط المقاعد", "نطاق حركة المستخدمين", "سعة نظام الأكسجين", "بروتوكول التشغيل", "متطلبات السلامة والترخيص المحلية"], aAfter: "تُضاف كل خيار إلى المشروع بعد تقييم السلامة والملاءمة الفنية." },
  ...
  es: {
    ...
    meta: {
      ...
      models: { title: "Modelos | HBOT Chamber Tech", desc: "Oslo, Dubai, Tokyo, Tokyo Plus, Milano y Geneva — seis modelos de cámaras hiperbáricas de oxígeno." },
      ...
      quadCube: { title: "Milano | HBOT Chamber Tech", desc: "Una cámara hiperbárica de oxígeno espaciosa para cuatro personas, de diseño cúbico." },
    ...
    home: {
      hero: {
        eyebrow: "HBOT CITY TECH",
        title: "Respira en\nla Cumbre",
        subtitle: "HBOT Chamber Tech es una nueva marca especializada en tecnología hiperbárica que combina experiencia de ingeniería desde 2007 con software conectado, seguridad específica por modelo y diseño cuidado.",
        cta_primary: "Explorar Modelos",
        cta_secondary: "Iniciar el Configurador",
        trust_line: "Ingeniería avanzada · Seguridad y conformidad por modelo"
      },
      stats: [
      ...
      tech_teaser: {
        ...
        text: "La serie HBOT City Tech integra CityConnect™, CityOS™, CityAI™, CitySync™ y CityGuard™ en una arquitectura de producto conectada.",
        cta: "Explorar la Tecnología"
      },
      models_teaser: {
        eyebrow: "HBOT CITY TECH",
        title: "Nuestros Modelos",
        subtitle: "Seis modelos para necesidades individuales, profesionales y hospitalarias.",
    ...
    technology: {
      ...
      pillars: {
        connect: {
          ...
          desc: "La serie HBOT City Tech integra CityConnect™, CityOS™, CityAI™, CitySync™ y CityGuard™ en una arquitectura de producto conectada.",
          features: [
      ...
      comparison: {
        ...
        col_city: "HBOT City Tech Series",
        rows: [
          { feature: "Conectividad a Internet", competitor: "Ninguna u opcional", city: "CityConnect™ — De serie, 24/7" },
          { feature: "Actualizaciones de Software OTA", competitor: "Ninguna, firmware fijo", city: "CityOS™ — Actualización continua" },
          { feature: "Monitorización Remota", competitor: "Limitada o inexistente", city: "CityConnect™ — Panel en vivo" },
          { feature: "Soporte de IA", competitor: "Ninguno", city: "CityAI™ — Protocolo dinámico" },
          { feature: "Integración EMR/HIS", competitor: "Manual o inexistente", city: "CitySync™ — HL7/DICOM automático" },
          { feature: "Mantenimiento Predictivo", competitor: "Ninguno, mantenimiento reactivo", city: "CityGuard™ — Aviso previo al fallo" },
          { feature: "Informes Automáticos", competitor: "Ninguno", city: "CitySync™ — Informe al final de la sesión" },
          { feature: "Diagnóstico Remoto", competitor: "Ninguno, requiere llamada de servicio", city: "CityCare™ — Resolución remota" },
          { feature: "Nivel de Ruido", competitor: "60–70 dB", city: "CitySilent™ — <60 dB" },
          { feature: "Registro de Seguridad Digital", competitor: "Ninguno", city: "CityGuard™ — Registro cifrado en la nube" }
        ]
      },
      roadmap: {
    ...
    modelsOverview: {
      header: { eyebrow: "HBOT CITY TECH", title: "Nuestros Modelos", subtitle: "Desde el uso individual hasta cámaras multipuesto de escala hospitalaria — seis modelos." },
    ...
    modelDuoPlus: {
      ...
      specs: [
        ...
        { label: "Rango de Presión", value: "2.0 – 3.0 ATA" },
        { label: "Pureza de Oxígeno", value: "93–95%" },
        { label: "Seguridad", value: "Sistema de válvula de emergencia" },
        { label: "Control", value: "Sistema de control dual" },
    ...
    modelQuadCube: {
      breadcrumb: "Milano", eyebrow: "MILANO", title: "Milano",
      faq_title: "Preguntas frecuentes sobre el Milano",
    ...
    modelNexus: {
      ...
      specs: [
        ...
        { label: "Rango de Presión", value: "3.0 – 6.0 ATA" },
        { label: "Pureza de Oxígeno", value: "93–95%" },
        { label: "Seguridad", value: "Sistema de válvula de emergencia" },
    ...
    modelsFaq: {
      ...
      "duo-plus": [
        ...
        { q: "¿En qué rango de presión funciona el Tokyo Plus?", a: "Entre 2.0 y 3.0 ATA, adecuado para uso institucional de mayor presión." },
      ...
      "quad-cube": [
        { q: "¿Para cuántas personas es el Milano y cómo es su diseño?", a: "El Milano es una cámara premium para cuatro personas, sentado, con un amplio interior en forma de cubo." },
        { q: "¿Con qué materiales se acaba el interior del Milano?", a: "Incluye interior de cuero acolchado e iluminación LED ambiental; puedes elegir los colores de las paredes interiores y del asiento por separado de nuestra paleta estándar." },
        { q: "¿En qué rango de presión funciona el Milano?", a: "Entre 2.0 y 6.0 ATA, adecuado para uso institucional." },
        { q: "¿Cómo funciona el sistema de control del Milano?", a: "Incluye una unidad de control independiente, adecuada para el control por parte de un operador en clínicas y centros de bienestar." },
        { q: "¿Cómo obtengo un presupuesto para el Milano?", a: "Selecciona el Milano en el configurador, elige los colores interiores y exteriores, y ve una estimación de precio al instante; luego solicita un presupuesto final mediante el formulario." }
      ],
      "nexus": [
        ...
        { q: "¿En qué rango de presión funciona el Geneva?", a: "Entre 3.0 y 6.0 ATA, con una pureza de oxígeno del 93–95%." },
    ...
    configurator: {
      intro: {
        ...
        sound_off: "Silenciar",
        welcome: "Bienvenido al configurador"
      },
      ...
      guide: {
        ...
        items: [
          ...
          { scenario: "Uso institucional, quiero un interior de cámara espacioso", model: "Milano", modelId: "quad-cube", usage: "institutional" },
      ...
      ext_color_preview_note: "Cuando existe una imagen aprobada para el acabado seleccionado, se actualiza la vista previa de la cámara; los demás acabados se registran en la carta de materiales, el resumen y la oferta. El tono RAL definitivo se aprueba por separado antes de la producción.",
      ext_color_locked_note: "Este modelo se ofrece en Blanco Perla estándar, conforme a los requisitos de dispositivos médicos. Si desea un color diferente, póngase en contacto con nuestro equipo de ventas.",
      ...
      lounge_decor_note: "No hay vista previa de la decoración interior para la cámara horizontal. El color interior es blanco estándar.",
      ...
      render_preparing_label: "Render en preparación",
      ...
      models: [
        ...
        { id: "quad-cube", name: "Milano", tagline: "4 Personas · Cabina Espaciosa" },
  ...
  pt: {
    ...
    meta: {
      ...
      models: { title: "Modelos | HBOT Chamber Tech", desc: "Oslo, Dubai, Tokyo, Tokyo Plus, Milano e Geneva — seis modelos de câmaras de oxigênio hiperbárico." },
      ...
      quadCube: { title: "Milano | HBOT Chamber Tech", desc: "Uma câmara de oxigênio hiperbárico espaçosa em design cubo para quatro pessoas." },
    ...
    home: {
      hero: {
        ...
        title: "Respire\nno Topo",
        subtitle: "A HBOT Chamber Tech é uma nova marca focada em tecnologia hiperbárica, combinando experiência de engenharia desde 2007 com software conectado, segurança específica por modelo e design cuidadoso.",
        cta_primary: "Explorar Modelos",
        cta_secondary: "Iniciar o Configurador",
        trust_line: "Engenharia avançada · Segurança e conformidade por modelo"
      },
      stats: [
        { value: "6", label: "Modelos HBOT City Tech" },
      ...
      tech_teaser: {
        ...
        text: "A série HBOT City Tech reúne CityConnect™, CityOS™, CityAI™, CitySync™ e CityGuard™ numa arquitetura de produto conectada.",
        cta: "Conheça a Tecnologia"
      },
      models_teaser: {
        eyebrow: "SÉRIE HBOT CITY TECH",
        title: "Nossos Modelos",
        subtitle: "Seis modelos para necessidades individuais, profissionais e hospitalares.",
    ...
    technology: {
      ...
      pillars: {
        connect: {
          ...
          desc: "A série HBOT City Tech reúne CityConnect™, CityOS™, CityAI™, CitySync™ e CityGuard™ numa arquitetura de produto conectada.",
          features: [
      ...
      comparison: {
        ...
        col_city: "Série HBOT City Tech",
        rows: [
          { feature: "Conectividade à Internet", competitor: "Nenhuma ou opcional", city: "CityConnect™ — De série, 24/7" },
          { feature: "Atualizações de Software OTA", competitor: "Nenhuma, firmware fixo", city: "CityOS™ — Atualização contínua" },
          { feature: "Monitoramento Remoto", competitor: "Limitado ou inexistente", city: "CityConnect™ — Painel ao vivo" },
          { feature: "Suporte de IA", competitor: "Nenhum", city: "CityAI™ — Protocolo dinâmico" },
          { feature: "Integração EMR/HIS", competitor: "Manual ou inexistente", city: "CitySync™ — HL7/DICOM automático" },
          { feature: "Manutenção Preditiva", competitor: "Nenhuma, manutenção reativa", city: "CityGuard™ — Alerta antes da falha" },
          { feature: "Relatórios Automáticos", competitor: "Nenhum", city: "CitySync™ — Relatório ao final da sessão" },
          { feature: "Diagnóstico Remoto", competitor: "Nenhum, exige chamada de serviço", city: "CityCare™ — Resolução remota" },
          { feature: "Nível de Ruído", competitor: "60–70 dB", city: "CitySilent™ — <60 dB" },
          { feature: "Registro Digital de Segurança", competitor: "Nenhum", city: "CityGuard™ — Registro criptografado na nuvem" }
        ]
      },
      roadmap: {
        eyebrow: "ROTEIRO",
    ...
    modelsOverview: {
      header: { eyebrow: "SÉRIE HBOT CITY TECH", title: "Nossos Modelos", subtitle: "Do uso individual para uma pessoa a câmaras multiassento em escala hospitalar — seis modelos." },
    ...
    modelDuoPlus: {
      ...
      specs: [
        ...
        { label: "Faixa de Pressão", value: "2.0 – 3.0 ATA" },
    ...
    modelQuadCube: {
      breadcrumb: "Milano", eyebrow: "MILANO", title: "Milano",
      faq_title: "Perguntas frequentes sobre o Milano",
    ...
    modelNexus: {
      ...
      specs: [
        ...
        { label: "Faixa de Pressão", value: "3.0 – 6.0 ATA" },
        { label: "Pureza de Oxigênio", value: "93–95%" },
        { label: "Segurança", value: "Sistema de válvula de emergência" },
    ...
    modelsFaq: {
      ...
      "duo-plus": [
        ...
        { q: "Em qual faixa de pressão o Tokyo Plus opera?", a: "Entre 2,0 e 3,0 ATA, adequado para uso institucional de maior pressão." },
      ...
      "quad-cube": [
        { q: "Para quantas pessoas é o Milano e como é seu design?", a: "O Milano é uma câmara premium para quatro pessoas, sentado, com um amplo interior em formato de cubo." },
        { q: "Com quais materiais o interior do Milano é acabado?", a: "Vem com interior em couro acolchoado e iluminação LED ambiente; você pode escolher as cores das paredes internas e do assento separadamente em nossa paleta padrão." },
        { q: "Em qual faixa de pressão o Milano opera?", a: "Entre 2,0 e 6,0 ATA, adequado para uso institucional." },
        { q: "Como funciona o sistema de controle do Milano?", a: "Vem com uma unidade de controle independente, adequada para controle por operador em clínicas e centros de bem-estar." },
        { q: "Como faço para obter um orçamento para o Milano?", a: "Selecione o Milano no configurador, escolha as cores internas e externas, e veja uma estimativa de preço instantânea; depois solicite um orçamento final pelo formulário." }
      ],
      "nexus": [
        ...
        { q: "Em qual faixa de pressão o Geneva opera?", a: "Entre 3,0 e 6,0 ATA, com pureza de oxigênio de 93–95%." },
    ...
    configurator: {
      intro: {
        ...
        sound_on: "Ativar som",
        sound_off: "Silenciar",
        welcome: "Bem-vindo ao configurador"
      },
      ...
      guide: {
        ...
        items: [
          ...
          { scenario: "Uso institucional, quero uma câmara com interior espaçoso", model: "Milano", modelId: "quad-cube", usage: "institutional" },
      ...
      ext_color_preview_note: "Quando existe uma imagem aprovada para o acabamento escolhido, a pré-visualização da câmara é atualizada; os restantes acabamentos ficam registados na carta de materiais, no resumo e na proposta. O tom RAL final é aprovado separadamente antes da produção.",
      ext_color_locked_note: "Este modelo é oferecido na cor Branco Pérola padrão, de acordo com os requisitos de dispositivos médicos. Se desejar uma cor diferente, entre em contato com nossa equipe de vendas.",
      ...
      lounge_decor_note: "Não há pré-visualização da decoração interior para a câmara horizontal. A cor interna padrão é branca.",
      ...
      render_preparing_label: "Render em preparação",
      ...
      models: [
        ...
        { id: "quad-cube", name: "Milano", tagline: "4 Pessoas · Cabine Espaçosa" },
  ...
  de: {
    ...
    meta: {
      ...
      models: { title: "Modelle | HBOT Chamber Tech", desc: "Oslo, Dubai, Tokyo, Tokyo Plus, Milano und Geneva — sechs Modelle hyperbarer Sauerstoffkammern." },
      ...
      quadCube: { title: "Milano | HBOT Chamber Tech", desc: "Eine geräumige hyperbare Sauerstoffkammer im Cube-Design für vier Personen." },
    ...
    home: {
      hero: {
        eyebrow: "HBOT CITY TECH",
        title: "Atmen Sie\nauf dem Gipfel",
        subtitle: "HBOT Chamber Tech ist eine neue, auf Hyperbarik-Technologie spezialisierte Marke und verbindet Ingenieurserfahrung seit 2007 mit vernetzter Software, modellspezifischer Sicherheit und durchdachtem Design.",
        cta_primary: "Modelle entdecken",
        cta_secondary: "Konfigurator starten",
        trust_line: "Fortschrittliche Technik · Modellspezifische Sicherheit und Konformität"
      },
      stats: [
      ...
      tech_teaser: {
        ...
        text: "Die HBOT City Tech-Serie vereint CityConnect™, CityOS™, CityAI™, CitySync™ und CityGuard™ in einer vernetzten Produktarchitektur.",
        cta: "Technologie entdecken"
      },
      models_teaser: {
        eyebrow: "HBOT CITY TECH",
        title: "Unsere Modelle",
        subtitle: "Sechs Modelle für individuelle, professionelle und klinische Anforderungen.",
    ...
    technology: {
      ...
      pillars: {
        connect: {
          ...
          desc: "Die HBOT City Tech-Serie vereint CityConnect™, CityOS™, CityAI™, CitySync™ und CityGuard™ in einer vernetzten Produktarchitektur.",
          features: [
      ...
      comparison: {
        ...
        col_city: "HBOT City Tech Series",
        rows: [
          { feature: "Internetkonnektivität", competitor: "Keine oder optional", city: "CityConnect™ — Serienmäßig, rund um die Uhr" },
          { feature: "OTA-Software-Updates", competitor: "Keine, feste Firmware", city: "CityOS™ — Fortlaufend aktualisiert" },
          { feature: "Fernüberwachung", competitor: "Eingeschränkt oder keine", city: "CityConnect™ — Live-Dashboard" },
          { feature: "KI-Unterstützung", competitor: "Keine", city: "CityAI™ — Dynamisches Protokoll" },
          { feature: "EMR-/KIS-Integration", competitor: "Manuell oder keine", city: "CitySync™ — Automatisch, HL7/DICOM" },
          { feature: "Vorausschauende Wartung", competitor: "Keine, reaktive Wartung", city: "CityGuard™ — Warnung vor Ausfall" },
          { feature: "Automatische Berichterstattung", competitor: "Keine", city: "CitySync™ — Bericht am Ende der Sitzung" },
          { feature: "Ferndiagnose", competitor: "Keine, Servicetermin erforderlich", city: "CityCare™ — Fernbehebung" },
          { feature: "Geräuschpegel", competitor: "60–70 dB", city: "CitySilent™ — <60 dB" },
          { feature: "Digitales Sicherheitsprotokoll", competitor: "Keine", city: "CityGuard™ — Verschlüsseltes Cloud-Protokoll" }
        ]
      },
      roadmap: {
        eyebrow: "ROADMAP",
    ...
    modelsOverview: {
      header: { eyebrow: "HBOT CITY TECH", title: "Unsere Modelle", subtitle: "Von der individuellen Nutzung durch eine Person bis zu Mehrplatz-Kammern im Krankenhausmaßstab — sechs Modelle." },
    ...
    modelDuoPlus: {
      ...
      specs: [
        ...
        { label: "Druckbereich", value: "2,0 – 3,0 ATA" },
        { label: "Sauerstoffreinheit", value: "93–95%" },
    ...
    modelQuadCube: {
      breadcrumb: "Milano", eyebrow: "MILANO", title: "Milano",
      faq_title: "Häufige Fragen zum Milano",
    ...
    modelNexus: {
      ...
      specs: [
        ...
        { label: "Druckbereich", value: "3.0 – 6.0 ATA" },
        { label: "Sauerstoffreinheit", value: "93–95%" },
        { label: "Sicherheit", value: "Notfallventilsystem" },
    ...
    modelsFaq: {
      ...
      "duo-plus": [
        ...
        { q: "In welchem Druckbereich arbeitet der Tokyo Plus?", a: "Zwischen 2,0 und 3,0 ATA, geeignet für institutionellen Einsatz mit höherem Druck." },
      ...
      "quad-cube": [
        { q: "Für wie viele Personen ist der Milano ausgelegt und wie ist sein Design?", a: "Der Milano ist eine Premium-Kammer für vier Personen, sitzend, mit geräumigem würfelförmigem Innenraum." },
        { q: "Mit welchen Materialien ist der Innenraum des Milano ausgestattet?", a: "Er verfügt über gestepptes Lederinterieur und LED-Ambientebeleuchtung; Innenwand- und Sitzfarben können Sie separat aus unserer Standardpalette wählen." },
        { q: "In welchem Druckbereich arbeitet der Milano?", a: "Zwischen 2,0 und 6,0 ATA, geeignet für institutionellen Einsatz." },
        { q: "Wie funktioniert das Bediensystem des Milano?", a: "Er verfügt über eine unabhängige Bedieneinheit, geeignet für die Bedienung durch Personal in Kliniken und Wellnesszentren." },
        { q: "Wie erhalte ich ein Angebot für den Milano?", a: "Wählen Sie den Milano im Konfigurator, legen Sie Innen- und Außenfarben fest und sehen Sie sofort eine Preisschätzung; fordern Sie anschließend über das Formular ein verbindliches Angebot an." }
      ],
      "nexus": [
        ...
        { q: "In welchem Druckbereich arbeitet der Geneva?", a: "Zwischen 3,0 und 6,0 ATA, bei 93–95 % Sauerstoffreinheit." },
    ...
    configurator: {
      intro: {
        ...
        welcome: "Willkommen im Konfigurator"
      },
      ...
      guide: {
        ...
        items: [
          ...
          { scenario: "Institutionelle Nutzung, geräumiger Innenraum gewünscht", model: "Milano", modelId: "quad-cube", usage: "institutional" },
      ...
      ext_color_preview_note: "Wenn für die gewählte Oberfläche ein freigegebenes Bild verfügbar ist, wird die Kammer-Vorschau aktualisiert; alle weiteren Oberflächen werden in Materialkarte, Übersicht und Angebot übernommen. Der endgültige RAL-Ton wird vor der Produktion separat bestätigt.",
      ext_color_locked_note: "Dieses Modell wird gemäß den Anforderungen an Medizinprodukte standardmäßig in Perlweiß angeboten. Falls Sie eine andere Farbe wünschen, wenden Sie sich bitte an unser Vertriebsteam.",
      ...
      lounge_decor_note: "Für die liegende Kammer ist keine Innenraum-Vorschau verfügbar. Die Innenraumfarbe ist standardmäßig Weiß.",
      ...
      render_preparing_label: "Render wird vorbereitet",
      ...
      models: [
        ...
        { id: "quad-cube", name: "Milano", tagline: "4 Personen · Geräumige Kabine" },
...
(() => {
  ...
  const basePricesEUR = [29900, 69900, 119900, 149900, 224900, 259900];
